...
function MainProduct({ product }: Props) {
  ...
  return (
    <>
      <div className="container m-auto md:m-0 flex flex-row md:flex-col lg:flex-row items-start gap-4 lg:gap-4 w-full max-h-[300px]">
        <div className="min-w-[150px] max-w-[150px] w-full h-40 md:h-48 md:hidden lg:flex lg:h-32 flex items-center justify-center overflow-hidden rounded-lg">
          <img
